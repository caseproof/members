            ...
            <article id="post-<?php the_ID(); ?>" <?php post_class('members-product'); ?>>
                ...
                <div class="entry-content">
                    ...
                    <div class="members-subscription-form-container">
                        ...
                        <?php 
                        // Try to use the subscription shortcode first, then fallback to basic form
                        if (class_exists('\\Members\\Subscriptions\\Plugin')) {
                            error_log('Root template: Plugin class exists, using subscription_form_shortcode');
                            ...
                            error_log('Root template: Using direct shortcode call');
                            echo do_shortcode('[members_subscription_form product_id="' . get_the_ID() . '"]');
                        } else {
                            error_log('Root template: Using fallback direct form');
                            // Basic form that works everywhere
