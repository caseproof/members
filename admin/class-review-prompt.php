	...
	public function review_notice() {
		...
		<div class="notice notice-info is-dismissible members-review-notice" id="members_review_notice">
			...
			<div id="members_review_no" style="display: none;">
				...
				<p>
					<a style="display: inline-block; margin-right: 10px;" href="https://google.com" onclick="delayReviewPrompt('remove')" target="_blank"><?php esc_html_e( 'Give Feedback', 'members' ); ?></a>
